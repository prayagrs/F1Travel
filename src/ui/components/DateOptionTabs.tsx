      ...
      <nav className="-mb-px flex space-x-8">
        {options.map((option) => (
          <button
            ...
            className={`flex flex-col items-start border-b-2 px-1 py-4 text-left text-sm font-medium transition-colors ${
          ...
          >
            ...
            <span className="font-bold text-inherit">{option.label}</span>
          </button>
        ))}
      </nav>
    </div>
